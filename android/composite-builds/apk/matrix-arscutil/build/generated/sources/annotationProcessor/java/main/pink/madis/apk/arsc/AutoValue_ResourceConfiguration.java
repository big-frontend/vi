...
// Generated by com.google.auto.value.processor.AutoValueProcessor
 final class AutoValue_ResourceConfiguration extends ResourceConfiguration {
  ...
  AutoValue_ResourceConfiguration(
      int size,
      int mcc,
      int mnc,
      byte[] language,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ResourceConfiguration) {
      ...
      return (this.size == that.size())
           && (this.mcc == that.mcc())
           && (this.mnc == that.mnc())
           && (Arrays.equals(this.language, (that instanceof AutoValue_ResourceConfiguration) ? ((AutoValue_ResourceConfiguration) that).language : that.language()))
           && (Arrays.equals(this.region, (that instanceof AutoValue_ResourceConfiguration) ? ((AutoValue_ResourceConfiguration) that).region : that.region()))
           ...
           && (Arrays.equals(this.localeScript, (that instanceof AutoValue_ResourceConfiguration) ? ((AutoValue_ResourceConfiguration) that).localeScript : that.localeScript()))
           && (Arrays.equals(this.localeVariant, (that instanceof AutoValue_ResourceConfiguration) ? ((AutoValue_ResourceConfiguration) that).localeVariant : that.localeVariant()))
           && (this.screenLayout2 == that.screenLayout2())
           && (Arrays.equals(this.unknown, (that instanceof AutoValue_ResourceConfiguration) ? ((AutoValue_ResourceConfiguration) that).unknown : that.unknown()));
    }
    return false;
  }
