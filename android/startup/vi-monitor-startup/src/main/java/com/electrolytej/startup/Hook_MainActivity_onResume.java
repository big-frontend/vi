...
@Keep
public class Hook_MainActivity_onResume {
    public static String className = "XActivity";
    public static String methodName = "onResume";
    ...
    public static void hook(Activity activity){
        ...
        TraceUtil.i(TAG_STARTUP_MONITOR,activity.getClass().getSimpleName()+"#onResume");
        backup(activity);
        TraceUtil.o();
    }
